...
import com.ismealdi.hidoc.utils.commons.Constants.INTENT.REQUEST.PERMISSION
import com.ismealdi.hidoc.utils.commons.Dialogs
...
abstract class AmActivity(@LayoutRes var layout: Int) : AppCompatActivity(), AmConnectionInterface, AmNetworkInterface {
    ...
    private fun initLocation() {
        if (isGrantedPermissions()) {
            ...
            ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission_group.CAMERA, Manifest.permission.CAMERA,
